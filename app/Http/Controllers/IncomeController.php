...
class IncomeController extends Controller
{
    ...
    {
//        //Cach 1 phai inject categoryIncome
////        $lscategoryincome = $this->categoryincome->whereNull('subCategoryiD')->get();
//
//        //Cach 2 khong can inject
////        $lscategoryincome = categoryIncome::whereNull('subCategoryiD')->get();
//
//        //Cach 3 thi phai nho ten table
//        $lscategoryincome =  DB::table('category_incomes')->whereNull('subCategoryiD')->get();
//
//        foreach ($lscategoryincome as $item) {
//            var_dump($item->name);
//        }
//        exit;
//
//        return view('income.index')->with('lsincome', $lscategoryincome);
...
//        return view('income.create')->with('lscategoryincome', $lscategoryincome);
    }
